...
class AEstrella:
    def __init__(self, mapa):
        ...
        self.inicio = Nodo(buscarPos(INICIO, mapa))
        self.fin = Nodo(buscarPos(FIN, mapa))
    ...
    def vecinos(self, nodo):
        vecinos = []
        if self.mapa.mapa[nodo.pos[0]+1][nodo.pos[1]] != OCUPADO:
            vecinos.append(Nodo([nodo.pos[0]+1, nodo.pos[1]], nodo))
        if self.mapa.mapa[nodo.pos[0]-1][nodo.pos[1]] != OCUPADO:
            vecinos.append(Nodo([nodo.pos[0]-1, nodo.pos[1]], nodo))
        if self.mapa.mapa[nodo.pos[0]][nodo.pos[1]-1] != OCUPADO:
            vecinos.append(Nodo([nodo.pos[0], nodo.pos[1]-1], nodo))
        if self.mapa.mapa[nodo.pos[0]][nodo.pos[1]+1] != OCUPADO:
            vecinos.append(Nodo([nodo.pos[0], nodo.pos[1]+1], nodo))
        if self.mapa.mapa[nodo.pos[0]+1][nodo.pos[1]+1] != OCUPADO:
